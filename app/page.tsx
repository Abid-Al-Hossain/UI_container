...
export default function Page() {
  const [state, setState] = useState<ContainerState>(DEFAULT_CONTAINER_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Container Studio" controls={controls} preview={output} /></AppShell>;
}
